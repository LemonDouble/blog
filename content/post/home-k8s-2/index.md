...
이후, `sudo apt update -y && sudo apt upgrade -y && sudo apt install linux-modules-extra-raspi` 로 필요한 종속성 설치를 진행합니다. ([라즈베리 파이 + Ubuntu 22.04에 K3S 설치해서 쓰기](https://lemondouble.github.io/p/%EB%9D%BC%EC%A6%88%EB%B2%A0%EB%A6%AC-%ED%8C%8C%EC%9D%B4--ubuntu-22.04%EC%97%90-k3s-%EC%84%A4%EC%B9%98%ED%95%B4%EC%84%9C-%EC%93%B0%EA%B8%B0/) 참고)
